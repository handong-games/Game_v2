...
{
    [CustomPropertyDrawer(typeof(GameplayEffectAttributeCaptureReference))]
    public sealed class GameplayEffectAttributeCaptureReferenceDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty snapshotProperty = property.FindPropertyRelative("_snapshot");
            ...
            Rect sourceRect = new(attributeRect.xMax + Spacing, position.y, columnWidth, position.height);
            Rect snapshotRect = new(sourceRect.xMax + Spacing, position.y, columnWidth, position.height);
            ...
            EditorGUI.PropertyField(sourceRect, sourceProperty, GUIContent.none);
            EditorGUI.PropertyField(snapshotRect, snapshotProperty, GUIContent.none);
