...
namespace Game.AbilitySystem
{
    ...
    public static class AbilityGameplayTags
    {
        ...
        public const string Ability_Combat_HealthMonitor = "Ability.Combat.HealthMonitor";
        public const string Ability_Combat_Death = "Ability.Combat.Death";
        ...
        public const string Event_Combat_Death = "Event.Combat.Death";
        ...
        public static readonly GameplayTag AbilityCombatHealthMonitor = GameplayTag.Define(Ability_Combat_HealthMonitor);
        public static readonly GameplayTag AbilityCombatDeath = GameplayTag.Define(Ability_Combat_Death);
        ...
        public static readonly GameplayTag EventCombatDeath = GameplayTag.Define(Event_Combat_Death);
