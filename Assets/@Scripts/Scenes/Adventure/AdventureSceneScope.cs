...
namespace Game.Scenes.Adventure
{
    ...
    public sealed class AdventureSceneScope : LifetimeScope
    {
        ...
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.Register<IntentBadgeWidgetEvents>(Lifetime.Scoped);
            ...
            builder.Register<AdventureSceneController>(Lifetime.Scoped);
            builder.Register<AdventureView>(Lifetime.Scoped);
            builder.RegisterEntryPoint<AdventureViewEventBinder>();
